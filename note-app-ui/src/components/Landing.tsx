  ...
  return (
    <div className="relative min-h-screen text-jet dark:text-dark-text bg-white dark:bg-dark-bg">
      <div className="relative">
        ...
        >
          <div className="container mx-auto px-4 py-24 space-y-8">
            ...
            <div className="flex justify-center gap-4 pt-8">
              <button
                onClick={() => navigate("/login")}
                className="px-8 py-3 bg-jet text-floral font-semibold rounded-lg hover:bg-jet/90 transition-all shadow-lg hover:shadow-xl"
              >
                Get Started
              </button>
              <div className="relative">
                ...
                />
                <FiSearch
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-jet/50"
                  size={18}
                />
              </div>
            </div>
              ...
              <div className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-2xl">
                ...
                >
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/8qmLgVl4r5Q"
                    title="Quill.ai"
        ...
        <motion.div ref={featuresRef} className="py-24">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={isFeatureInView ? { opacity: 1, y: 0 } : {}}
                  transition={{ duration: 1.6, delay: index * 0.3 }}
        ...
        {/* Benefits Section */}
        <motion.div ref={benefitsRef} className="py-24">
          <div className="container mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
